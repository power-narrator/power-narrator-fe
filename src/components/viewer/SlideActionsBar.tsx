...
export function SlideActionsBar({
  ...
  return (
    <Group gap="md" py="xs" style={{ borderBottom: "1px solid var(--mantine-color-dark-4)" }}>
      <Tooltip label="Individual slide sync is disabled in XML mode" disabled={!xmlCliEnabled}>
        <Button
          variant="default"
          size="xs"
      ...
      <Tooltip label="Disabled when XML CLI is enabled" disabled={!xmlCliEnabled}>
        <Button
          variant="default"
          size="xs"
